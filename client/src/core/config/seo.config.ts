...
export const SEO_CONFIG = {
  ...
  services: {
    ...
    keywords: "калькулятор буста PUBG, цена буста PUBG, стоимость прокачки ранга, буст ранга цена",
  ...
  aboutus: {
    ...
    keywords: "Spectre Boost, команда бустеров, буст PUBG отзывы, о нас",
...
export type SeoPageConfig = (typeof SEO_CONFIG)[keyof typeof SEO_CONFIG]
